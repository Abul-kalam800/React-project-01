...
const Charts = () => {
    ...
    return (
        <>
            ...
            <div className='lg:w-9/12 mx-auto md:w-full flex flex-col justify-center items-center gap-16'>
            <h2 className='text-3xl font-bold'>Barchart</h2>
                <BarChart width={300} height={400} data={studentsData} margin={20}>
            ...
            <h2 className='text-3xl font-bold'>Area Charts</h2>
                <AreaChart width={300} height={300} data={studentsData}>
